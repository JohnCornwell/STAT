...
#  Aug 03, 2022 07:05:07 PM CDT  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    vTcl::widgets::ttk::scrolledwindow::CreateCmd $site_3_0.scr47 \
        -borderwidth 2 -relief groove -background #000000 -height 488 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 1275 
    vTcl:DefineAlias "$site_3_0.scr47" "ScrolledWindow" vTcl:WidgetProc "Window" 1

    $site_3_0.scr47.01 configure -background #000000 \
        -borderwidth 2 \
        -height 75 \
        ...
        -width 125
    frame $site_3_0.scr47.01.fra49 \
        -background #000000 -height 404 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 1239 
    vTcl:DefineAlias "$site_3_0.scr47.01.fra49" "SwarmFrame_1" vTcl:WidgetProc "Window" 1
    set site_6_0 $site_3_0.scr47.01.fra49
    label $site_6_0.lab50 \
        -activebackground #f9f9f9 -activeforeground SystemButtonText \
        -background #000000 -compound left -disabledforeground #a3a3a3 \
        -font {-family Arial -size 24 -weight normal -slant roman -underline 0 -overstrike 0} \
        -foreground #f2b83d -highlightbackground $vTcl(actual_gui_bg) \
        -highlightcolor black -text {Task ($t)} 
    vTcl:DefineAlias "$site_6_0.lab50" "DemandDetailsLabel_1" vTcl:WidgetProc "Window" 1
    ...
    vTcl:DefineAlias "$site_6_0.lab109" "DemandProfileLabel_1" vTcl:WidgetProc "Window" 1
    ttk::combobox $site_6_0.tCo47 \
        \
        ...
        -takefocus {} 
    vTcl:DefineAlias "$site_6_0.tCo47" "DemandProfileEntry_1" vTcl:WidgetProc "Window" 1
    ...
    vTcl:DefineAlias "$site_6_0.lab52" "DemandAmplitudeLabel_1" vTcl:WidgetProc "Window" 1
    entry $site_6_0.ent53 \
        -background #f2b83d -disabledforeground #a3a3a3 -font TkFixedFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground #c4c4c4 \
        -selectforeground black -width 144 
    vTcl:DefineAlias "$site_6_0.ent53" "AmplitudeEntry_1" vTcl:WidgetProc "Window" 1
    ...
    vTcl:DefineAlias "$site_6_0.lab59" "DemandPeriodLabel_1" vTcl:WidgetProc "Window" 1
    entry $site_6_0.ent46 \
        ...
        -insertbackground black -selectbackground #c4c4c4 \
        -selectforeground black -width 144 
    vTcl:DefineAlias "$site_6_0.ent46" "PeriodEntry_1" vTcl:WidgetProc "Window" 1
    ...
    vTcl:DefineAlias "$site_6_0.lab47" "RangeLabel_1" vTcl:WidgetProc "Window" 1
    entry $site_6_0.ent48 \
        ...
        -insertbackground black -selectbackground #c4c4c4 \
        -selectforeground black -width 144 
    vTcl:DefineAlias "$site_6_0.ent48" "RangeEntry_1" vTcl:WidgetProc "Window" 1
    ...
    vTcl:DefineAlias "$site_6_0.lab49" "DemandFunctionLabel_1" vTcl:WidgetProc "Window" 1
    ...
    vTcl:DefineAlias "$site_6_0.ent50" "FunctionEntry_1" vTcl:WidgetProc "Window" 1
    place $site_6_0.lab50 \
        -in $site_6_0 -x 0 -relx 0.41 -y 0 -rely 0.076 -width 0 \
        -relwidth 0.18 -height 0 -relheight 0.061 -anchor nw \
        -bordermode ignore 
    place $site_6_0.lab109 \
        -in $site_6_0 -x 0 -relx 0.047 -y 0 -rely 0.304 -width 0 \
        -relwidth 0.158 -height 0 -relheight 0.057 -anchor nw \
        -bordermode ignore 
    place $site_6_0.tCo47 \
        -in $site_6_0 -x 0 -relx 0.203 -y 0 -rely 0.304 -width 0 \
        -relwidth 0.113 -height 0 -relheight 0.057 -anchor nw \
        -bordermode ignore 
    place $site_6_0.lab52 \
        -in $site_6_0 -x 0 -relx 0.359 -y 0 -rely 0.304 -width 0 \
        -relwidth 0.134 -height 0 -relheight 0.057 -anchor nw \
        -bordermode ignore 
    place $site_6_0.ent53 \
        -in $site_6_0 -x 0 -relx 0.523 -y 0 -rely 0.304 -width 144 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_6_0.lab59 \
        -in $site_6_0 -x 0 -relx 0.672 -y 0 -rely 0.304 -width 0 \
        -relwidth 0.121 -height 0 -relheight 0.057 -anchor nw \
        -bordermode ignore 
    place $site_6_0.ent46 \
        -in $site_6_0 -x 0 -relx 0.828 -y 0 -rely 0.304 -width 144 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_6_0.lab47 \
        -in $site_6_0 -x 0 -relx 0.23 -y 0 -rely 0.545 -width 0 \
        -relwidth 0.056 -height 0 -relheight 0.106 -anchor nw \
        -bordermode ignore 
    place $site_6_0.ent48 \
        -in $site_6_0 -x 0 -relx 0.302 -y 0 -rely 0.569 -width 144 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_6_0.lab49 \
        -in $site_6_0 -x 0 -relx 0.485 -y 0 -rely 0.569 -width 0 \
        -relwidth 0.125 -height 0 -relheight 0.057 -anchor nw \
        -bordermode ignore 
    place $site_6_0.ent50 \
        -in $site_6_0 -x 0 -relx 0.627 -y 0 -rely 0.569 -width 234 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.scr47.01.fra49 \
        -in $site_3_0.scr47.01 -x 0 -relx 0.008 -y 0 -rely 0.021 -width 0 \
        -relwidth 0.984 -height 0 -relheight 0.835 -anchor nw \
        -bordermode ignore 
    ...
    place $site_3_0.but53 \
        -in $site_3_0 -x 0 -relx 0.516 -y 0 -rely 0.913 -width 107 \
        -relwidth 0 -height 44 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but56 \
        -in $site_3_0 -x 0 -relx 0.406 -y 0 -rely 0.913 -width 107 \
        -relwidth 0 -height 44 -relheight 0 -anchor nw -bordermode ignore 
    ...
    place $site_3_0.scr47 \
        -in $site_3_0 -x 0 -y 0 -rely 0.152 -width 0 -relwidth 1 -height 0 \
        -relheight 0.743 -anchor nw -bordermode ignore 
