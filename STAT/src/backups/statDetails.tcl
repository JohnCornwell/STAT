...
proc vTclWindow.top1 {base} {
    ...
    label $site_3_0.lab50 \
        ...
        -foreground #f2b83d -text {Run Details} 
    ...
    button $site_3_0.but56 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Load 
    vTcl:DefineAlias "$site_3_0.but56" "LoadButton" vTcl:WidgetProc "Window" 1
    ...
    vTcl::widgets::ttk::scrolledtext::CreateCmd $site_3_0.scr139 \
        -borderwidth 2 -relief groove -background $vTcl(actual_gui_bg) \
        -height 466 -highlightbackground $vTcl(actual_gui_bg) \
        -highlightcolor black -width 408 
    ...
    place $site_3_0.lab50 \
        -in $site_3_0 -x 0 -relx 0.438 -y 0 -rely 0.076 -width 0 \
        -relwidth 0.134 -height 0 -relheight 0.061 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but53 \
        -in $site_3_0 -x 0 -relx 0.906 -y 0 -rely 0.289 -width 107 \
        -relwidth 0 -height 44 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but56 \
        -in $site_3_0 -x 0 -relx 0.906 -y 0 -rely 0.198 -width 107 \
        -relwidth 0 -height 44 -relheight 0 -anchor nw -bordermode ignore 
    ...
    place $site_3_0.scr135 \
        -in $site_3_0 -x 0 -relx 0.555 -y 0 -rely 0.274 -width 0 \
